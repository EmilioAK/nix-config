---
name: herdr-guide
description: "Use when the user asks about understanding, setting up, configuring, learning, or troubleshooting Herdr. This guide is for helping a human use Herdr; use the herdr skill instead when operating Herdr from inside a Herdr pane."
---
